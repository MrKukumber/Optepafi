...
/// <summary>
/// Represents converter of path report of specific type to its ViewModel.
///
/// These ViewModels can be than presented to View for displaying to user. It has one non generic predecessor, which should be never implemented right away. It is used mainly as type parameter of collections of convertors. This interface should be always implemented instead.  
    ...
    where TPathReport : IPathReport
{
    ...
    /// <summary>
    /// Method for converting path report to ViewModel.
    ///
    /// It retrieves report to be converted to Vm and ground graphic source to which report (or included graphics in it) is related.  
...
/// <summary>
/// Non-generic predecessor of <see cref="IPathReport2VmConverter{TGraphicsObject}"/>.
///
