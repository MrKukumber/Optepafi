...
/// <summary>
/// One of generic visitor interfaces for <see cref="IMap"/> implementations. It provides access to modified visitor pattern on maps, where only one generic method is required to be implemented.
