...
public class ObjectRepreRep : IMapRepreRepresentativ<IObjectRepre<ITemplate>>
{
    ...
    public IMapRepreConstructor<ITemplate, IMap, IObjectRepre<ITemplate>>[] MapRepreConstrs { get; } = { new ElevDataDependentConstr<Orienteering_ISOM_2017_2, OMAP, ObjectRepreOrienteeringOmap>(Orienteering_ISOM_2017_2.Instance, OMAPFormat.Instance) };
}
