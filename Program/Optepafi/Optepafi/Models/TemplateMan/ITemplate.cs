...
/// The main goal is not ensuring that caller implements specific method for every ITemplate implementation, but for ability to retrieve templates real type in form of type parameter.  
...
public interface ITemplate
{
    ...
    /// 
    /// For more information on this pattern see <see cref="ITemplateGenericVisitor{TOut,TConstraint,TOtherParams}"/>.  
    /// </summary>
