...
{
    /// <summary>
    /// Aggregates graphics of provided map into provided collector. Aggregation will probably run asynchronously, so aggregated objects could be used right after their submission.
