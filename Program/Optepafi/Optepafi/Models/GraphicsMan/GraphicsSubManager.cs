    ...
    where TVertexAttributes : IVertexAttributes where TEdgeAttributes : IEdgeAttributes
{
    ...
    /// <summary>
    /// Method for aggregating of paths graphics. It accepts path and collector which will be filled with aggregated objects.
    ...
    /// <summary>
    /// Method for aggregating of searching states graphics. It accepts searching state and collector which will be filled with aggregated objects.
