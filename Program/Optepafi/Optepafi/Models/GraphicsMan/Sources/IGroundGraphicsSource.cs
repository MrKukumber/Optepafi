...
{
    /// <summary>
    /// Area that contains all graphic objects of this source. It is used for assigning width and height of canvas as well as conversion from <c>MapCoordinate</c>s to <c>CanvasCoordinate</c>s.
    /// </summary>
