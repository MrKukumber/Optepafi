...
/// 
/// For this purpose it defines two overloads of method <see cref="GetElevation(GeoCoordinate)"/> which supports <c>GeoCoordinate</c>s as well as <c>MapCoordinate</c>s with geo referenced origin.  
